...
def binance_api(api_key, api_secret):
    ...
    out10 = out9.assign(**{'txId': '0', 'type':'deposits'})
    ...
    return (balance)
    #balance.to_csv('join.csv', index = False, header=True)

#binance_api(api_key_j, api_secret_j)
binance_api(api_key_m, api_secret_m)
